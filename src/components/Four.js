  ...
  return (
    <div style={{ marginTop: "30vh" }}>
      <Container>
        <Row>
          <Col>
            <Button className="myBtn" onClick={() => handleShow(0)}>
              {names[0]}
            </Button>
          </Col>
          <Col>
            <Button className="myBtn" onClick={() => handleShow(1)}>
              {names[1]}
            </Button>
          </Col>
          <Col>
            <Button className="myBtn" onClick={() => handleShow(2)}>
              {names[2]}
            </Button>
          </Col>
          <Col>
            <Button className="myBtn" onClick={() => handleShow(3)}>
              {names[3]}
            </Button>
          </Col>
          ...
          <Modal show={show} onHide={handleClose}>
            ...
            <Modal.Footer>
              <Button className="btn-sm btn-dark" onClick={handleClose}>
                Close
              </Button>
            </Modal.Footer>
          </Modal>
